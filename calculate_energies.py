...
def calculate_energies(possible_beads_pos,beads_pos,epsilon,sigma_squared,updated_angles,angle_last_bead,bending_energy):
    ...
    for ii in range(len(possible_beads_pos)):
        ...
        energies[ii] = energies[ii]+bending_energy*np.cos(0.5*(updated_angles[ii]-angle_last_bead) # this line is new!
    return energies;